...
const lessons = [
  {difficulty:"Advanced",topic:"science",icon:"⚛️",title:"Quantum Computing",tag:"PHYSICS",concept:"Quantum computers use <em>qubits</em> rather than ordinary bits. A normal bit is 0 or 1; a qubit can be described as a combination of states until it is measured.",example:"Imagine a coin spinning in the air. Before it lands, it is not simply heads or tails. A qubit uses a quantum version of this idea called <b>superposition</b>.",question:"Which property lets a qubit represent a combination of states?",options:["Encryption","Superposition","Compilation","Compression"],answer:1,takeaway:"The key idea is that qubits use quantum states, but measurement still produces a definite result.",why:"This matters because quantum algorithms can exploit interference to solve some specialized problems differently from classical computers."},
  {difficulty:"Beginner",topic:"technology",icon:"🌐",title:"How the Internet Works",tag:"TECHNOLOGY",concept:"The internet is a huge network of connected computers. Your device sends packets through routers to servers, which send information back.",example:"Think of a package delivery system. A message is split into small packages, routed through a network and reassembled when they arrive.",question:"What do routers primarily do?",options:["Create websites","Route data between networks","Store passwords","Generate electricity"],answer:1,takeaway:"The key idea is that the internet moves data in packets across many networks rather than through one central machine.",why:"This matters because the same basic architecture lets billions of devices communicate even when routes or servers change."},
  {difficulty:"Beginner",topic:"psychology",icon:"🧠",title:"The Attention Trap",tag:"PSYCHOLOGY",concept:"Your attention is limited. Switching rapidly between tasks feels productive, but each switch carries a mental cost.",example:"Imagine reading while someone keeps tapping your shoulder. You can continue, but your brain keeps paying a tiny switching cost.",question:"What does rapid task switching generally add?",options:["More focus","A switching cost","More memory","More sleep"],answer:1,takeaway:"The key idea is that attention switching has a cost, even when switching feels effortless.",why:"This matters when studying: reducing unnecessary context switches can leave more attention available for the task that actually matters."},
  {difficulty:"Intermediate",topic:"space",icon:"🌌",title:"Black Holes",tag:"ASTRONOMY",concept:"A black hole is a region of spacetime where gravity is so strong that past the event horizon, nothing—not even light—can escape.",example:"Picture a waterfall. Far upstream you can swim away; past a certain point the current becomes impossible to overcome.",question:"What is the event horizon?",options:["A black hole’s surface","A boundary beyond which escape is impossible","A visible star","The center of a galaxy"],answer:1,takeaway:"The key idea is that the event horizon is a boundary in spacetime, not a solid surface.",why:"This matters because it separates what can still escape from what is causally trapped once the boundary is crossed."},
  {difficulty:"Beginner",topic:"biology",icon:"🧬",title:"DNA",tag:"BIOLOGY",concept:"DNA is a molecule that stores biological instructions. Genes provide information used by cells to build proteins and regulate processes.",example:"Think of DNA as a huge library. Genes are like individual recipes that cellular machinery can read.",question:"What does DNA primarily store?",options:["Heat","Biological information","Electricity","Oxygen"],answer:1,takeaway:"The key idea is that DNA stores information in the sequence of its chemical bases.",why:"This matters because cells use that information as part of the system that builds and regulates the molecules needed for life."},
  {difficulty:"Beginner",topic:"science",icon:"🌈",title:"Why Is the Sky Blue?",tag:"PHYSICS",concept:"Sunlight contains many wavelengths. Earth’s atmosphere scatters shorter blue wavelengths more strongly than longer red wavelengths.",example:"Shine a flashlight through a misty room: tiny particles scatter light sideways. Earth’s air does something similar.",question:"Which color is scattered more strongly by Earth’s atmosphere?",options:["Red","Blue","Infrared","Black"],answer:1},
  {difficulty:"Advanced",topic:"technology",icon:"🔐",title:"Public-Key Cryptography",tag:"CYBERSECURITY",concept:"Public-key cryptography uses a pair of mathematically related keys. A public key can be shared while a private key is kept secret.",example:"Imagine a mailbox anyone can put a letter into, but only the owner has the key to open.",question:"Which key should normally remain secret?",options:["Public key","Private key","Browser key","Router key"],answer:1,takeaway:"The key idea is that a public key can be shared while the matching private key is protected.",why:"This matters because public-key systems help establish secure communication without first sharing one secret key with everyone."},
  {difficulty:"Intermediate",topic:"psychology",icon:"🧩",title:"Confirmation Bias",tag:"PSYCHOLOGY",concept:"Confirmation bias is the tendency to notice, interpret or remember information in ways that support beliefs we already hold.",example:"If you think a brand is unreliable, you may remember its failures while overlooking times it worked normally.",question:"What does confirmation bias tend to favor?",options:["Evidence that challenges beliefs","Information consistent with existing beliefs","Random information","Perfectly neutral memories"],answer:1,takeaway:"The key idea is that existing beliefs can influence which evidence we notice and remember.",why:"This matters whenever you evaluate claims: deliberately looking for disconfirming evidence can reveal what a first impression missed."},
  {difficulty:"Beginner",topic:"history",icon:"🏛️",title:"The Printing Press",tag:"HISTORY",concept:"Movable-type printing made it faster and cheaper to reproduce texts in large quantities, helping information circulate more widely.",example:"Before mass printing, copying a book by hand took a long time. A press made many similar pages efficiently.",question:"What did printing primarily make easier?",options:["Mass reproduction of texts","Building ships","Predicting weather","Generating electricity"],answer:0,takeaway:"The key idea is that movable type made repeated copies much more practical than copying every page by hand.",why:"This matters because lower copying costs helped texts circulate among larger audiences."},
  {difficulty:"Intermediate",topic:"economics",icon:"📈",title:"Supply and Demand",tag:"ECONOMICS",concept:"Supply describes how much sellers offer, while demand describes how much buyers want. Their interaction helps determine market prices.",example:"If concert tickets are scarce but many people want them, buyers may compete for limited supply, pushing price upward.",question:"What can happen when demand rises while supply stays fixed?",options:["Price pressure can rise","Demand disappears","Supply becomes infinite","Money stops existing"],answer:0,takeaway:"The key idea is that price is influenced by the interaction of what buyers want and what sellers offer.",why:"This matters because changes in scarcity or willingness to buy can change market outcomes."},
  {difficulty:"Intermediate",topic:"space",icon:"🪐",title:"Why Planets Orbit",tag:"ASTRONOMY",concept:"A planet’s forward motion combines with the Sun’s gravitational pull. The planet continually falls toward the Sun while moving sideways.",example:"Swing a ball on a string: it wants to travel straight while the string pulls inward, creating a curved path.",question:"What keeps a planet bound to the Sun?",options:["Gravity","Sound","Magnetism alone","Clouds"],answer:0,takeaway:"The key idea is that orbital motion combines forward velocity with gravitational acceleration toward the Sun.",why:"This matters because an orbit is not a planet hovering in place; it is continuous motion under gravity."},
  {difficulty:"Intermediate",topic:"biology",icon:"🫀",title:"How Your Heart Beats",tag:"BIOLOGY",concept:"The heart is a muscular pump. Electrical signals coordinate contractions so blood moves through the lungs and body.",example:"Think of a two-stage pump: one side sends blood to the lungs while the other sends oxygen-rich blood around the body.",question:"What coordinates the heart’s contractions?",options:["Electrical signals","Bones","Hair follicles","Stomach acid"],answer:0,takeaway:"The key idea is that electrical activity coordinates the heart muscle's contractions.",why:"This matters because timing lets the chambers fill and pump blood in an organized sequence."},
  {difficulty:"Intermediate",topic:"math",icon:"∞",title:"Infinity",tag:"MATHEMATICS",concept:"Infinity is not an ordinary number. It describes something without an upper bound, and infinite sets can have surprising relationships.",example:"The counting numbers never end: 1, 2, 3, 4, and so on. There is always another number.",question:"Is infinity an ordinary finite number?",options:["Yes","No","Only on weekends","Only in geometry"],answer:1,takeaway:"The key idea is that infinity describes unboundedness rather than an ordinary finite number.",why:"This matters because treating infinity like a normal number can lead to incorrect conclusions in mathematics."}
];
